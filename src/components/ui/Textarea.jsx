...
/**
 * Reusable Form Textarea component with ref forwarding
 */
  ...
  return (
    <div className="space-y-1.5 w-full font-sans text-left">
      ...
      <textarea
        ...
        } rounded text-sm text-[var(--color-ink)] placeholder-[var(--color-subtle-ink)]/75 focus:outline-none transition-all resize-none ${className}`}
        {...props}
      />
      {error && (
